...
class TestKpiMode(object):
    ...
    def test_12_YIL115C_Anc_2_253_codon_aln(self):
        ...
        with open(f"{here.parent}/expected/12_YIL115C_Anc_2.253_codon_aln.fasta_kpi", 'r') as expected:
            expected_content = expected.read()
    ...
    def test_12_YIL115C_Anc_2_253_aa_aln(self):
        ...
        with open(f"{here.parent}/expected/12_YIL115C_Anc_2.253_aa_aln.fasta_kpi", 'r') as expected:
            expected_content = expected.read()
    ...
    def test_24_ENSG00000163519_aa_aln(self):
        ...
        with open(f"{here.parent}/expected/24_ENSG00000163519_aa_aln.fasta_kpi", 'r') as expected:
            expected_content = expected.read()
    ...
    def test_24_ENSG00000163519_codon_aln(self):
        ...
        with open(f"{here.parent}/expected/24_ENSG00000163519_codon_aln.fasta_kpi", 'r') as expected:
            expected_content = expected.read()
    ...
    def test_EOG092C0CZK_aa(self):
        ...
        with open(f"{here.parent}/expected/EOG092C0CZK_aa_aln.fasta_kpi", 'r') as expected:
            expected_content = expected.read()
    ...
    def test_EOG092C4VOX_aa(self):
        ...
        with open(f"{here.parent}/expected/EOG092C4VOX_aa_aln.fasta_kpi", 'r') as expected:
            expected_content = expected.read()
