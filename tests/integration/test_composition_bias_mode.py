...
class TestCompositionBiasMode(object):
    def test_simple_alignment(self):
        input_file = f"{here.parent}/samples/simple.fa"
        output_file = "output/simple.fa_composition_bias"
        kwargs = dict(
            ...
            codon=False,
            gaps=0.9,
            mode=TrimmingMode.composition_bias,
            use_log=False,
        ...
        with open(f"{here.parent}/expected/simple.fa_composition_bias", "r") as expected:
