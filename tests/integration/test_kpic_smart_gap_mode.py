...
class TestKPICSmartGapsMode(object):
    def test_simple_no_change(self):
        ...
        with open(
            f"{here.parent}/expected/simple.fa_kpic_smart_gaps", "r"
        ) as expected:
    ...
    def test_12_YIL115C_Anc_2_253_codon_aln(self):
        ...
        output_file = "output/12_YIL115C_Anc_2.253_codon_aln.fasta.clipkit_kpic_smart_gaps"
        ...
        with open(
            f"{here.parent}/expected/12_YIL115C_Anc_2.253_codon_aln.clipkit_kpic_smart_gaps", "r"
        ) as expected:
            expected_content = expected.read()
    ...
    def test_12_YIL115C_Anc_2_253_aa_aln(self):
        ...
        with open(
            f"{here.parent}/expected/12_YIL115C_Anc_2.253_aa_aln.clipkit_kpic_smart_gaps", "r"
        ) as expected:
            expected_content = expected.read()
    ...
    def test_24_ENSG00000163519_aa_aln(self):
        ...
        with open(
            f"{here.parent}/expected/24_ENSG00000163519_aa_aln.clipkit_kpic_smart_gaps", "r"
        ) as expected:
            expected_content = expected.read()
    ...
    def test_24_ENSG00000163519_codon_aln(self):
        ...
        with open(
            f"{here.parent}/expected/24_ENSG00000163519_codon_aln.clipkit_kpic_smart_gaps", "r"
        ) as expected:
            expected_content = expected.read()
    ...
    def test_EOG091N44M8_aa(self):
        ...
        with open(f"{here.parent}/expected/EOG091N44M8_aa.clipkit_kpic_smart_gaps", "r") as expected:
            expected_content = expected.read()
    ...
    def test_EOG091N44M8_nt(self):
        ...
        with open(f"{here.parent}/expected/EOG091N44M8_nt.clipkit_kpic_smart_gaps", "r") as expected:
            expected_content = expected.read()
    ...
    def test_EOG092C0CZK_aa(self):
        ...
        usage: clipkit EOG092C0CZK_aa_aln.fasta -m kpic-smart-gap
        """
        ...
        with open(
            f"{here.parent}/expected/EOG092C0CZK_aa_aln.clipkit_kpic_smart_gaps", "r"
        ) as expected:
            expected_content = expected.read()
